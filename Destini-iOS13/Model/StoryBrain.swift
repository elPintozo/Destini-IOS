...
struct StoryBrain {
    ...
    var buttonOneDestination: Int = 0
    var buttonTwoText: String = ""
    var buttonTwoDestination: Int = 0
    ...
    /**
     ...
     option -> 2 : Choice 2
     */
    mutating func getStory(option: Int) -> String{
        ...
        if option == -1{
            ...
            storyIndex = histories[storyIndex].choice1Destination
        }// two choice selected
        else{
            storyIndex = histories[storyIndex].choice2Destination
        }
        
        // set text buttons
        buttonOneText = histories[storyIndex].choice1
        buttonTwoText = histories[storyIndex].choice2
        
        // set destination values
        buttonOneDestination = histories[storyIndex].choice1Destination
        buttonTwoDestination = histories[storyIndex].choice2Destination
        
        return histories[storyIndex].title
    }
    
    mutating func getTextChoiceOne() -> String{
        return buttonOneText
    }
    
    mutating func getTextChoiceTwo() -> String{
